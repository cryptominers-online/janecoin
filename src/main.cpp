...
unsigned int nStakeMinAge = 1 * 24 * nOneHour; // 1 day as zero time weight
unsigned int nStakeMaxAge = 20 * 24 * nOneHour; // 20 days as full weight
unsigned int nStakeTargetSpacing = 6 * 60; // 6-minute stakes spacing
int64_t nTargetSpacing = 6 * 60;  // Same as the above
...
static const int64_t nTargetTimespan = 6 * 15 * 60;
...
void ThreadScriptCheck(void*) {
    ...
    RenameThread("JaneCoin-scriptch");
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in JaneCoin
...
bool CBlock::CheckBlock(bool fCheckPOW, bool fCheckMerkleRoot, bool fCheckSig) const
{
    ...
    if (fProofOfStake)
    {
        ...
        // JaneCoin: check proof-of-stake block signature
...
unsigned char pchMessageStart[4] = { 0xb7, 0xf7, 0xe7, 0xee };
