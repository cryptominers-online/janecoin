...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("JANE");
    case mBTC: return QString("mJANE");
    case uBTC: return QString::fromUtf8("μJANE");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("JaneCoins"));
    case mBTC: return QString(QObject::tr("Milli-JaneCoins (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-JaneCoins (1 / 1,000,000)"));
    default: return QString("???");
    }
}
